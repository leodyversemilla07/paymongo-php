...
use Paymongo\Entities\LedgerBalance;
use Paymongo\Entities\Listing;

/**
 * Service for managing PayMongo Ledger Balances.
 */
class LedgerBalanceService extends BaseService
{
    private const URI = '/ledger_balances';
    ...
    public function all(array $params = []): Listing
    {
        ...
        foreach ($apiResource->data as $row) {
            ...
            $objects[] = new LedgerBalance($rowResource);
        }
